...
#[derive(Debug)]
pub struct ThemeLibraryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ThemeLibraryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ThemeLibrary processing");
    
    let mut processor = ThemeLibraryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ThemeLibraryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ThemeLibraryProcessor::new(false);
